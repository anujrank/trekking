...
function Footer() {
  return (
    <footer className="relative text-white py-12" style={{backgroundImage: 'url(/footer.png)', backgroundSize: 'cover', backgroundPosition: 'center', backgroundAttachment: 'fixed'}}>
      {/* Dark Overlay */}
