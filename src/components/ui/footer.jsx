...
function Footer() {
  return (
    <footer className="bg-[#043324] text-[#A3E2CD] font-sans">
      {/* Top Banner Section */}
      <div className="relative bg-[url('/footer-img.png')] bg-cover bg-center border-b-5 border-white">
        <div className="absolute inset-0 bg-black/80"></div>
        <div className="flex flex-col relative items-center text-center gap-6 py-16 px-6 max-w-4xl mx-auto">
          ...
          <p className="text-md md:text-lg text-[#DFFAF0] max-w-2xl">
            Tell us where you want to go, who's coming, and what your family
      ...
      <div className="max-w-7xl mx-auto px-6 py-16 grid grid-cols-1 md:grid-cols-4 gap-10 md:gap-6 text-sm">
        ...
        <div className="flex flex-col gap-4">
          ...
          <p className="text-[#8FD8BF] leading-relaxed max-w-xs">
            Custom adventure itineraries for active families. 62 destinations,
            15 years of experience, 500+ trips planned.
          </p>
          {/* Social Icons Placeholder */}
          <div className="flex gap-3 mt-2 text-white opacity-80">
            <span className="w-7 h-7 border border-[#08422F] rounded-full flex items-center justify-center bg-[#063f2d] cursor-pointer hover:bg-[#08422F]">
              <FaInstagram />
            </span>
            <span className="w-7 h-7 border border-[#08422F] rounded-full flex items-center justify-center bg-[#063f2d] cursor-pointer hover:bg-[#08422F]">
              p
