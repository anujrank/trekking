  ...
  return (
    <>
      {/* =========================================================================
          ...
          ========================================================================= */}
      <div className="relative w-full h-[60vh] md:h-[80vh] lg:h-screen overflow-hidden bg-[#0d1b2a] flex flex-col justify-between">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center z-20 select-none pointer-events-none px-4">
          <motion.span
            ...
            className="text-white/80 tracking-[0.4em] bg-[#022c22] py-1 px-5 rounded-full flex gap-2 items-center uppercase text-xs md:text-sm mb-4 font-semibold drop-shadow-sm"
          >
            <TiStarFullOutline className="hidden lg:flex text-2xl text-yellow-400"/>Stories & Perspectives<TiStarFullOutline className="hidden lg:flex text-2xl text-yellow-400"/>
          </motion.span>
      ...
      <div className="w-full min-h-screen text-[#022c22] bg-[#f4f6f9] px-6 py-24 md:py-32">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-base md:text-lg text-emerald-950/70 max-w-xl mx-auto leading-relaxed font-medium">
            Read comprehensive guides, global trends, and firsthand accounts
            penned by our expert adventurers worldwide.
          </p>
        </div>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {blogs.map((item) => (
            ...
            >
              <div className="flex flex-col h-full justify-between bg-white rounded-2xl overflow-hidden shadow-[0_4px_20px_rgba(2,44,34,0.04)] hover:shadow-[0_20px_35px_rgba(2,44,34,0.09)] hover:-translate-y-1 border border-emerald-950/5 transition-all duration-300 pb-4">
                <div>
                  ...
                  <div className=" flex justify-center">
                    <button className="bg-[#022c22]  text-white px-5 py-1 rounded-lg cursor-pointer flex items-center gap-1">
                      View More<GoArrowUpRight className="text-xl" />
                    </button>
                  </div>
                </div>
