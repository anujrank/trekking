const blogs = [
  {
    id: 1,
    slug: "southeast-asia-with-kids",
    img: "/southeast.png",
    region: "Southeast Asia",
    title: "Southeast Asia with Kids: The Complete Family Guide",
    dis: "Thailand vs Vietnam vs Cambodia vs Bali — which country is right for your family and how to combine them.",
    time: "14 min read",
    age: "Ages All ages",
    content: `
    # Southeast Asia with Kids: The Complete Family Guide

    Southeast Asia is the most diverse travel region on Earth — ten countries within a four-hour flight of each other, each with its own language, food culture, architecture, and adventure offering.

    For active families, it's an embarrassment of riches. The question isn't whether to go. It's where to start, how to sequence the countries, and which specific experiences are worth the logistical effort with children in tow.

    This guide is built from 15 years of planning family itineraries across the region. It's the honest version — not a marketing brochure, but a planner's real assessment of what works for which families.

    ## The 6 Best Southeast Asian Countries for Active Family Travel
    ...
    **Standout Family Experiences**
    - Ethical elephant sanctuary (Chiang Mai)
    - Sea kayaking limestone caves (Krabi)
    - Thai cooking class with kids
    - Floating market by longboat

    **Budget:** $150–$280/day for a family of 4

    **Avoid:** Phuket's Patong Beach and Full Moon Party islands.
    ...
    **Best for:** Culturally curious families, foodie families, teens who engage with history.
    ...
    Vietnam's north-to-south route is one of the great family travel narratives. Every few days you're in a completely different landscape and culture.

    **Standout Family Experiences**
    - Ha Long Bay overnight cruise
    - Hoi An lantern release
    - Basket boat rides
    - Royal tomb cycling in Hue

    **Budget:** $120–$200/day for a family of 4

    **Avoid:** Trying to cover the entire country in one trip.
    ...
    **Budget:** $100–$180/day for a family of 4

    **Insider Tip:** Hire an Apsara Authority-licensed guide at Angkor Wat.
    ...
    **Best for:** Mixed-age family groups, surf families, families wanting villa-style accommodation.
    ...
    Bali offers culture, surfing, nature, and comfortable family-friendly villas.

    **Standout Family Experiences**
    - Tegallalang rice terraces cycling
    - Mount Batur sunrise hike
    - Ubud cooking class
    - Gili Islands snorkeling

    **Budget:** $160–$260/day for a family of 4

    **Avoid:** Kuta and Seminyak if traveling with young children.
    ...
    **Standout Family Experiences**
    - Mekong slow boat
    - Kuang Si waterfall
    - Gibbon Experience treehouse stay
    - Elephant encounter at Mandalao

    **Budget:** $90–$160/day for a family of 4
    ...
    **Best for:** Wildlife lovers, ages 6+, nature-focused families.
    ...
    The only place on Earth where families can potentially see wild orangutans, pygmy elephants, proboscis monkeys, and sun bears in one trip.

    **Standout Family Experiences**
    - Kinabatangan River night safari
    - Sepilok Orangutan Rehabilitation Centre
    - Borneo Sun Bear Conservation Centre

    **Budget:** $150–$250/day for a family of 4

    ---

    ## The Best Multi-Country Family Itineraries

    ### 2 Weeks: Thailand + Cambodia

    Bangkok (2 nights) → Chiang Mai (3 nights) → Siem Reap (3 nights) → Phnom Penh (2 nights) → Koh Lanta (3 nights)

    **Best Ages:** 7+

    **Budget:** $3,200–$5,000 for a family of 4

    ### 3 Weeks: Vietnam + Laos

    Hanoi → Ha Long Bay → Luang Prabang → Mekong Slow Boat → Hue → Hoi An → Da Nang

    **Best Ages:** 8+

    **Budget:** $4,500–$7,000 for a family of 4

    ### 4 Weeks Ultimate Route
    ...
    **Budget:** $6,000–$9,500 for a family of 4
    ...
    ### November – February
    The best overall season. Cool temperatures, low rainfall, and manageable humidity.

    ### March – April
    Excellent for Vietnam and Cambodia. Thailand becomes extremely hot.

    ### May – October
    Green landscapes, lower prices, and fewer crowds. Expect periodic rain.

    ### December – January
    Peak holiday season. Prices increase by 30–50%.

    ### Best Value Window
    Late January to early February offers excellent weather at significantly lower costs.

    ---

    ## Practical Guide: Health, Money & Getting Around
    ...
    - Eat freshly cooked street food.
    - Confirm ice is made from filtered water when unsure.

    ### Getting Around Between Countries

    Budget airlines such as AirAsia, VietJet, Scoot, and Lion Air connect major Southeast Asian cities for $20–$80 per flight when booked early.

    For families, flying is usually preferable to overnight buses.

    ### Want a Custom Southeast Asia Family Itinerary?

    Build a personalized route based on your children's ages, budget, interests, and travel style.
    `,
  },
  {
    id: 2,
    slug: "thailand-with-kids",
    img: "/thailand-kids.png",
    region: "Southeast Asia",
    title: "Thailand with Kids: A 10-Day Family Adventure Itinerary",
  ...
  {
    id: 3,
    slug: "vietnam-with-kids",
    img: "/vietnam-kids.png",
    region: "Southeast Asia",
    title: "Vietnam with Kids: A 12-Day Itinerary from Hanoi to Hoi An",
  ...
  },
  {
    ...
    title: "The Ultimate Costa Rica Family Adventure Itinerary (7 Days)",
  ...
  {
    id: 5,
    slug: "iceland-with-kids",
    img: "/iceland-kids.png",
    region: "Europe",
    title: "Iceland with Kids: A 7-Day Ring Road Family Adventure",
  ...
  {
    id: 6,
    slug: "best-family-adventure-destinations-2026",
    img: "/top-10.png",
    region: "Best Of",
    title: "10 Best Adventure Travel Destinations for Active Families in 2026",
